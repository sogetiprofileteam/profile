...
import { ConsultantEducationCertificationsEditComponent } from '../consultant-education-certification-edit/consultant-education-certification-edit.component';
...
export class ConsultantEducationCertificationsComponent implements OnInit {
  ...
  openEditCertificationEducationDialog() {
    this.dialog.open(ConsultantEducationCertificationsEditComponent, { data: { } });
  }
