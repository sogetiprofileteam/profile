...
export class NotificationsService {
  ...
  openSummaryUpdatedSnackBar() {
    const snackbarRef = this.snackbar.open('Summary Updated!', null, {
      horizontalPosition: 'end',
      panelClass: ['green-snackbar'],
      duration: 3000
    });
  ...
  openErrorUpdatingSummarySnackBar() {
    const snackbarRef = this.snackbar.open('Error updating summary', null, {
      horizontalPosition: 'end',
      panelClass: ['red-snackbar'],
      duration: 3000
    });
  ...
  openTooManySkillsSnackBar() {
    const snackbarRef = this.snackbar.open(
      'Error: Only 10 display skills can be selected',
      null,
      {
        horizontalPosition: 'end',
        panelClass: ['red-snackbar'],
